...
**Note:** Because **RvizVisualTools** remote control feature has not been ported to ROS2 this tutoral has made use of xterm and a simple prompter to help the user progress through each demo step.
