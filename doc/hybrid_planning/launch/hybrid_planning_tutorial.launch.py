...
def generate_launch_description():
    ...
    global_planner_param = load_yaml("moveit2_tutorials", "config/global_planner.yaml")
    local_planner_param = load_yaml("moveit2_tutorials", "config/local_planner.yaml")
    hybrid_planning_manager_param = load_yaml(
        "moveit2_tutorials", "config/hybrid_planning_manager.yaml"
    )
